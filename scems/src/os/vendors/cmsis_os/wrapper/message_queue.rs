...
impl MessageQueue
{
    pub fn new(message_count: u32, message_size: u32) -> IResult<Self>
    {
        let handle =
            unsafe { osMessageQueueNew(message_count, message_size, null()).cast_opt().ok_or(IError::InstanceCreate) }?;
