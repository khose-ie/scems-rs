...
typedef enum
{
    ...
    SCES_RET_ERR_LOW_LEVEL_FAILURE       = 8,
    SCES_RET_ERR_INSTANCE_CREATE_FAILURE = 9,
    SCES_RET_ERR_INSTANCE_NOT_FOUND      = 10,
    SCES_RET_ERR_INSTANCE_DUPLICATE      = 11,
    SCES_RET_ERR_INSTANCE_IN_USE         = 12,
    SCES_RET_ERR_INSTANCE_INVALID        = 13,
    SCES_RET_ERR_NOT_SUPPORT             = 14,
    SCES_RET_ERR_NOT_AVAILABLE           = 15,
    SCES_RET_ERR_FORMAT_FAILURE          = 16,
